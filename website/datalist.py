...
class DataList:
  def anime():
    ...
    "akame ga kill","black clover","god of high school",
    "beezlebub","elfen lied","berserk","hellsing","yu yu hakusho",
    "when they cry","ghost in the shell","kuroko no basket",
    "pokemon","akira","dragon ball","another","samurai champloo",
    "monster","the seven deadly sins","code geass","blue exorcist",
    "inuyasha","shokugeki no soma","erased","mirai nikki","psycho pass",
    "naruto","durarara","clannad","full metal alchemist",
    "fate zero","soul eater","noragami","konosuba","black butler",
    "angel beats","sword art online","hunter x hunter",
    "re: zero","spirited away","jojo's bizarre adventure",
